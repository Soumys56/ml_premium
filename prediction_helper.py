...
models_directory = os.path.join(current_script_dir, "artifacts")
model_young = joblib.load(os.path.join(models_directory, "model_young.joblib"))
print(model_young)
model_rest = joblib.load(os.path.join(models_directory, "model_rest.joblib"))
scaler_young = joblib.load(os.path.join(models_directory, "scaler_young.joblib"))
scaler_rest = joblib.load(os.path.join(models_directory, "scaler_rest.joblib"))
